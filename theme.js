document.addEventListener("DOMContentLoaded", () => {
	...
	const dark_theme = () => {
		...
		root.style.setProperty(
			"--background",
			'linear-gradient(130deg, rgba(17, 17, 17, 0.37), rgba(29, 28, 28, 0.158)), url("../img/backgrounds/artur-shamsutdinov-unsplash.jpg"), no-repeat, center'
		);
	...
	const light_theme = () => {
		...
		root.style.setProperty(
			"--background",
			'linear-gradient(130deg, rgba(238 ,238 ,238 ,.441), rgba(226 ,227 ,227 ,.599)), url("../img/backgrounds/christopher-gower-unsplash.jpg"), no-repeat, center'
		);
